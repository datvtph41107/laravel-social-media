...
// user table ->username so sanh voi index tham so
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/group', [GroupController::class, 'store'])
        ->name('group.create');
    // {group:slug} auto query select group được truyền từ tham số controller
    // customizing the key
    ...
    Route::get('post/dowload/{attachment}', [PostController::class, 'dowloadAttachment'])
        ->name('post.dowload');
